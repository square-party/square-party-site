...
layout: base.njk
title: Write it in
description: Every election, every voter, every level — write someone in. The working mission of Square Party.
---
...
[Read the full how-to-vote page →](/paul/campaign/how-to-vote/)
...
{% set tallyId = site.tally.writeitin %}
{% set tallyTitle = "Pledge to write someone in" %}
{% set tallyHeight = "260" %}
