...
- **Revenue offsets.** AmeriCorps estimates a $17-to-$1 return on investment for every tax dollar (Voices for National Service, 2026). Even if optimistic, service members performing real work in healthcare, infrastructure, education, and disaster response are producing economic value. If each service member produces $30,000 in economic value (conservative), the net cost drops to roughly $40 billion.
- **Displacement of existing spending.** Federal, state, and local governments currently spend substantial sums on functions that service members could partially staff — disaster response (FEMA), conservation (NPS, Forest Service), healthcare support, infrastructure maintenance. Some portion of the $80 billion replaces existing expenditures rather than adding to them.
- **Education benefits structure.** The current GI Bill provides up to roughly $27,000/year for education. A civil service education benefit need not be as generous but should be substantial enough to function as a meaningful incentive. Modeled at $15,000 per year of service (redeemable over 4 years = $60,000 total), the education award liability adds approximately $15 billion/year — but this displaces a significant fraction of existing federal student aid spending ($112 billion in grants and loans in FY2022, per CBO).
...
- Medical exemption: Documented physical or mental conditions that prevent participation. Determined by medical review board, not self-certification.
- Educational deferment: Up to age 24 for those enrolled in higher education. Service must be completed before age 26.
- Hardship deferment: Primary caregivers for dependents or individuals whose service would create undue family hardship. Case-by-case review.
- Conscientious objection to military track: Automatic placement in civilian track. No exemption from service entirely.
- No exemptions for wealth, employment, or political status.
...
- Section 2: Definitions (service, tracks, eligible persons, service period)
- Section 3: Establishment of the National Service Administration within CNCS
- Section 4: Mandatory Service Requirement (all persons born on or after [cutoff date], residing in the United States, must complete 12 months of service before age 26)
- Section 5: Service Tracks and Placement
- Section 6: Deferment, Exemption, and Hardship Provisions
- Section 7: Compensation, Benefits, and Education Awards
- Section 8: Transition Timeline and Phase-In
- Section 9: Enforcement (civil penalties for non-compliance; linkage to federal employment eligibility, student loan access, and professional licensing)
- Section 10: Oversight, Evaluation, and Reporting Requirements
...
- AmeriCorps. (2021). *Volunteering and Civic Life in America.*
- Bureau of Economic Analysis. (2025). GDP Q3 Advance Estimate.
- Bureau of Labor Statistics. (2016). *Volunteering in the United States.*
- *Butler v. Perry,* 240 U.S. 328 (1916).
- CDC National Center for Health Statistics. (2024). National Vital Statistics Reports.
- Congressional Budget Office. (2024). "Eliminate Federal Funding for National Community Service."
- Department of Defense. (2024). FY2025 Budget Request.
- *Herndon v. Chapel Hill–Carrboro City Board of Education,* 89 F.3d 174 (4th Cir. 1996).
- *Immediato v. Rye Neck School District,* 73 F.3d 454 (2d Cir. 1996).
...
- National Defense Authorization Act, FY2026 (Selective Service automatic registration provision).
...
- Universal National Service Act of 2013, H.R. 748, 113th Congress.
- Voices for National Service. (2026). "$17 return on investment" analysis.
- 50 U.S.C. § 3802 (Selective Service registration requirement).
