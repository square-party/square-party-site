...
- **Credible fear screening** (8 C.F.R. § 208.30): For individuals subject to expedited removal, a USCIS Asylum Officer determines whether there is a "significant possibility" of establishing eligibility.
- **Reasonable fear screening** (8 C.F.R. § 208.31): For certain individuals subject to reinstatement of a prior removal order, a higher screening standard applies.
- **Employment authorization** (8 C.F.R. § 208.7): Asylum applicants may apply for work authorization 150 days after filing. Work permits issued after December 4, 2025, are valid for 18 months (reduced from 5 years).
- **Asylum fee** (INA § 208(d)(3), as amended by P.L. 119-21, July 4, 2025): The Attorney General is now required (previously "may") to impose fees on asylum adjudication. The annual asylum fee is $102 as of February 1, 2026, for applications pending more than one year.
...
- [Project 1: IBPHTC](/paul/proposals/01-border-healthcare/) — the mega-station concept addresses the infrastructure deficit that contributes to asylum processing chaos. Integrated processing centers with on-site immigration courts, legal services, and healthcare could dramatically reduce processing times and improve outcomes.
- [Project 6: Mandatory Civil Service](/paul/proposals/06-mandatory-civil-service/) — service members in the public administration corps could staff immigration courts and processing centers, addressing the human capital shortage.
- [Project 5: The American Experiment](/paul/proposals/05-american-experiment/) — the asylum system is a test case for whether American institutions can function under stress. The gap between statutory promise and operational reality is precisely the kind of institutional failure the American Experiment diagnostic identifies.
...
- Asian Law Caucus. (2026). "Understanding the USCIS Pause on Asylum."
- ASAP Together. (2026). "How Are Laws Changing for Asylum Seekers?" (updated April 2026).
- Center for Immigration Studies. (2026). "USCIS to Resume Processing Some Asylum Applications."
- Congressional Research Service. (2025). "Asylum Process in Immigration Courts and Selected Trends," R47504.
- EOIR. (2025). Workload and Adjudication Statistics.
- Executive Office for Immigration Review. (2026). Q1 FY2026 data report.
- Immigration and Nationality Act, 8 U.S.C. § 1158 (Asylum).
- *INS v. Cardoza-Fonseca,* 480 U.S. 421 (1987).
- Mission Local. (2025). "S.F. has largest backlog of immigration cases in California."
- National Immigration Forum. (2024). Asylum wait time estimates.
- P.L. 119-21 (July 4, 2025) (asylum fee amendment).
- Presidential Proclamation. (2025). "Guaranteeing the States Protection Against Invasion," January 20, 2025.
- Presidential Proclamation 10949. (2025). Travel restrictions, June 4, 2025.
- Presidential Proclamation. (2025). Expanded travel restrictions, December 16, 2025.
- SCOTUSblog. (2026). "Supreme Court asylum decision burdens already overworked DOJ," March 18, 2026.
- TRAC Immigration. (2025). Immigration Court Backlog data.
- *Urias-Orellana v. Bondi* (Supreme Court, 2026).
- USCIS. (2025). Policy Memorandum PM-602-0192.
- 8 C.F.R. Part 208 (Asylum regulations).
- 8 U.S.C. § 1158 (Asylum statute, as of April 3, 2026).
