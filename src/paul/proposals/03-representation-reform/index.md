...
- [Project 8: Campaign Finance](/paul/proposals/08-campaign-finance/) — competitive districts and accountable representation are less vulnerable to concentrated spending; campaign finance reform and representation reform reinforce each other.
- [Project 5: The American Experiment](/paul/proposals/05-american-experiment/) — declining civic participation is partly a response to representation that doesn't feel responsive. Constituent organizing closes the loop.
- [Project 2: Capitalism Game Maintenance](/paul/proposals/02-game-maintenance/) — diluted representation is one mechanism by which concentrated economic interests dominate the rule-making process.
