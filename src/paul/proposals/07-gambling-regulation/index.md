...
# Project 7 — The House Always Wins
...
- [Project 2: Capitalism Game Maintenance](/paul/proposals/02-game-maintenance/) — the prediction market explosion is regulatory arbitrage, the same phenomenon the game-maintenance framework identifies as a system failure. When the rules allow one class of companies to offer identical services without bearing the costs that competitors must pay, the game is broken.
- [Project 8: Campaign Finance](/paul/proposals/08-campaign-finance/) — prediction markets on political events create a new channel through which money can influence democratic outcomes, intersecting with the campaign finance challenge.
- [Project 5: The American Experiment](/paul/proposals/05-american-experiment/) — the question of who regulates gambling — states or the federal government — is a live experiment in federalism that connects to the broader democratic governance questions.
