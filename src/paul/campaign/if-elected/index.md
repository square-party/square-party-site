...
I have a handful of federal-level policy ideas — less specified than the PA-3 work, but with the kind of shape that might draw national interest if the movement reaches that scale. They're being written up in the [Ideas / Proposals section](/paul/proposals/), in various states of draft. I think they're good ideas. I also haven't done enough work yet on policy execution and task implementation to be confident about every detail. Major changes to the proposals are still possible.
