---
layout: empower.njk
title: EITC, VITA, and the new state credit (WPTC)
saveable: true
...
- **[PATH Act](/paul/campaign/empower/glossary/#path-act) refund hold:** the IRS cannot issue EITC refunds before mid-February
...
- **Administrative vulnerability (delivery infrastructure): HIGH** — VITA grant funding, audit policy, [TAS](/paul/campaign/empower/glossary/#tas) capacity, IRS Free File.
...
- Refundable credit.
- Eligibility: must qualify for federal EITC (or meet federal requirements while filing with an [ITIN](/paul/campaign/empower/glossary/#itin)).
