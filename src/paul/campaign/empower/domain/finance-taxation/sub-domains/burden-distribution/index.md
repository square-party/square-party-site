---
layout: empower.njk
title: State and Federal Burden Distribution
saveable: true
...
**16th Amendment.** Grounds the federal income tax framework — OBBBA-modified [TCJA](/paul/campaign/empower/glossary/#tcja) provisions, the EITC (cross-reference: [EITC, VITA &amp; the new state credit](/paul/campaign/empower/domain/finance-taxation/sub-domains/eitc-vita/)), and FICA's income taxation element.
...
**PA Constitution, Article VIII §1 — Uniformity Clause.** The flat PA Personal Income Tax rate is a legislative choice consistent with [uniformity-clause](/paul/campaign/empower/glossary/#article-viii-1) precedent, not a constitutional requirement. (A progressive PA PIT rate would face the same uniformity questions as a progressive Philadelphia wage tax — see [Wage Tax](/paul/campaign/empower/domain/finance-taxation/sub-domains/wage-tax/).)
...
- **[SALT cap](/paul/campaign/empower/glossary/#salt-cap):** raised to $40,000 through 2029; reverts to $10,000 in 2030.
...
**PA Corporate Net Income Tax (PA CNIT), 72 P.S. § 7401.** 2025 rate: 7.99% (declining; see [BIRT](/paul/campaign/empower/domain/finance-taxation/sub-domains/birt/) for the full schedule to 4.99% in 2031).

**PA Department of Revenue.** Administers PA PIT and PA SUT; separate from Philadelphia Department of Revenue.

**Working Pennsylvanians Tax Credit (WPTC).** See [EITC sub-domain](/paul/campaign/empower/domain/finance-taxation/sub-domains/eitc-vita/). First state EITC in PA history, 10% of federal, up to $805, effective Tax Year 2025.
...
- **Philadelphia wage tax:** $32,000 × 3.74% ≈ **$1,197** (without [Schedule SP](/paul/campaign/empower/glossary/#schedule-sp) refund; if she navigates Schedule SP successfully, effective rate 1.5% = $480)
...
1. Each paycheck: Philadelphia wage tax + FICA withheld automatically.
2. Each purchase: 8% sales tax embedded.
3. April 15: PA PIT return; federal income tax return with EITC claim.
4. First quarter of the following year: federal refund arrives (including EITC); PA refund arrives (including WPTC beginning 2025).
5. If self-employed: quarterly NPT + BIRT estimated payments + SE FICA quarterly payments in addition.
