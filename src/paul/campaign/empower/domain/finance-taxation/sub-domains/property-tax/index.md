---
layout: empower.njk
title: Philadelphia Property Tax
saveable: true
...
breadcrumbExtras:
  ...
  - { label: "Sub-Domains", href: "/paul/campaign/empower/domain/finance-taxation/sub-domains/" }
---
...
**PA Constitution, Article VIII §1 — the [uniformity clause](/paul/campaign/empower/glossary/#article-viii-1).** The constitutional driver of Philadelphia's 2014 transition to [Actual Value Initiative](/paul/campaign/empower/glossary/#avi) (AVI) assessment. Uniform assessment at actual market value is constitutionally required; pre-AVI fractional assessment was a sustained uniformity violation; AVI was legally necessary to achieve constitutional compliance. This is the most consequential constitutional provision for the property tax sub-domain.
...
**Article VIII §2(a)(v) — Charitable Exemption authorization.** Cross-reference to [Tax-Exempt Institutions &amp; PILOET](/paul/campaign/empower/domain/finance-taxation/sub-domains/tax-exempt-institutions/). Large institutional properties appear as tax-exempt on OPA rolls; the charitable-exemption sub-domain owns the analysis of why and what follows.
...
**IRC § 164 / [SALT cap](/paul/campaign/empower/glossary/#salt-cap).** OBBBA (July 2025) raised the cap to $40,000 through 2029, reverting to $10,000 in 2030. Most PA-3 households take the standard deduction and are unaffected by the cap. Cross-reference: [Burden Distribution](/paul/campaign/empower/domain/finance-taxation/sub-domains/burden-distribution/).
...
**PA Consolidated Assessment Law, 72 P.S. § 5020-101 et seq.** Uniform market-value assessment mandate; the [Office of Property Assessment](/paul/campaign/empower/glossary/#opa)'s legal mandate; the statutory provision that required AVI. *Statutory stability: high. Administrative vulnerability: low — ministerial requirement.*
...
**PA [Real Estate Tax Sale Law](/paul/campaign/empower/glossary/#retsl) (RETSL), 72 P.S. § 5860.101 et seq.** Upset sale; judicial sale; notice requirements; redemption period. These statutory timelines determine how quickly a homeowner can lose property to lien sale. *Statutory stability: high.*
...
1. **Mechanism.** Caps assessed value; locks in that assessment for as long as the homeowner remains eligible. Does not eliminate tax; caps growth relative to full market assessment.
2. **Appreciation trigger.** 50% increase in one year OR 75% increase over five years.
3. **Tenure requirement.** 10 years of continuous ownership and occupancy.
4. **Income cap.** $96,350 for a household of 1 in 2025; higher limits for larger households (verify current limits at phila.gov/revenue).
5. **Application requirement.** Must apply; not automatic. Application deadline September 30 (recently extended from January 31 to give additional outreach time).
...
**[Owner Occupied Payment Agreement](/paul/campaign/empower/glossary/#oopa) (OOPA).** Income-based payment plan for delinquent taxes; some homeowners qualify for zero-dollar monthly agreements. Applications accepted year-round. Most homeowners encountering delinquency do not know OOPA exists.
...
**[Board of Revision of Taxes](/paul/campaign/empower/glossary/#brt) (BRT).** Assessment appeals; filing deadline is the **first Monday in October of the year preceding the tax year** (e.g., for TY 2026, the deadline is the first Monday in October 2025). First Level Review (FLR) is available informally after a valuation notice; a formal BRT appeal follows.
...
1. OPA assessment notice received → First Level Review window (informal) → BRT formal appeal deadline (first Monday in October). Professional representation significantly increases success rate; appeal capacity varies by income and education.
2. LOOP eligibility trigger (assessment increase of 50% in one year or 75% over five years) → application window (deadline September 30) → documentation submission → approval.
3. Delinquency pathway: missed payment → Department of Revenue notices → penalty accrual → lien certificate sale to private investor → redemption period → potential judicial sale.
4. Homestead Exemption: one-time application (deadline typically September 13 for following tax year) → permanent enrollment unless deed changes.
