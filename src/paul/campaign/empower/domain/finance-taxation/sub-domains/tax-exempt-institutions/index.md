---
layout: empower.njk
title: Tax-Exempt Institutions & PILOET
saveable: true
...
**IRC § 501(c)(3).** Federal predicate for exemption claims. No private inurement. Form 990 disclosure. [Schedule H](/paul/campaign/empower/glossary/#schedule-h) for hospital community benefit reporting. *Statutory stability: high. Administrative vulnerability: high for IRS oversight of large exempt organizations — enforcement intensity is administrative discretion.*

**IRC §§ 511-514 ([UBIT](/paul/campaign/empower/glossary/#ubit) — Unrelated Business Income Tax).** The boundary between exempt-purpose income and taxable commercial activities. Administratively interpretable without statutory change; more permissive interpretation reduces UBIT exposure for large institutions. *Administrative vulnerability: high — IRS enforcement discretion.*

### State statutory layer — Act 55 of 1997

**Act 55, 10 P.S. § 375 — "Institutions of Purely Public Charity."** Five-part test (the [HUP test](/paul/campaign/empower/glossary/#hup-test), named for the foundational case):
...
1. City Council oversight hearing testimony → requires advance notice, travel, organized advocacy capacity → produces political pressure but no binding obligation.
2. Public records access → Controller CAFR (complex financial document); Council materials → requires institutional literacy.
3. Judicial challenge to hospital exemption under Act 55 Part 2 → requires advocacy organization or Attorney General action; has not been brought.
4. State legislative advocacy → Act 55 amendment or new PILOET mandate legislation → requires coalition capacity and multi-year campaign.
