...
saveable: true
savedContext: "Empower · Mental Health"
state: in-review
verified: true
cluster: B
order: 2
description: Mental health policy in PA-3 from the federal floor through DBHIDS and CBH — the public infrastructure for serious mental illness, parity, civil commitment, children's behavioral health, crisis response, and the forensic intersection.
updated: 2026-05-18
breadcrumbExtras:
  - { label: "Domains", href: "/paul/campaign/empower/#domains" }
subhead: "Mental health in PA-3 — the Home Rule architecture Philadelphia built, the federal funding flows it depends on, and where the obligations the law creates outrun the dollars the law supplies."
signature:
  detail: |
    <g fill="#15192a">
      <path d="M 92 60 C 60 60, 45 85, 50 115 C 53 135, 70 150, 92 148 L 92 60 Z"/>
      <path d="M 108 60 C 140 60, 155 85, 150 115 C 147 135, 130 150, 108 148 L 108 60 Z"/>
    </g>
    <g stroke="#efe7d6" stroke-width="2" stroke-linecap="round" fill="none" opacity="0.7">
      <path d="M 72 80 C 78 88, 70 96, 78 105"/>
      <path d="M 70 115 C 80 122, 72 130, 82 138"/>
      <path d="M 128 80 C 122 88, 130 96, 122 105"/>
      <path d="M 130 115 C 120 122, 128 130, 118 138"/>
    </g>
hookParagraph: >-
  Philadelphia built something unusual. DBHIDS and Community Behavioral Health
  run a behavioral-health managed-care plan at the county level — the only
  arrangement of its kind in Pennsylvania, and one of the most ambitious in
  the country. The legal architecture above it is comprehensive: the ADA's
  *Olmstead* integration mandate, the federal Mental Health Parity Act,
  Medicaid expansion, the 988 crisis line, the CCBHC model. The federal
  funding architecture, by contrast, is fragmented across SAMHSA, CMS, HRSA,
  ED, DOJ, ACF, and the VA, each with its own grant cycle and its own rules.
  <strong>The North and West Philadelphia residents who turn to the public
  mental-health system are the ones who feel the gap between what the law
  promises and what the money supports.</strong>
---
