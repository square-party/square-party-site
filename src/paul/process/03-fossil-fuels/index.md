...
- [Capitalism Game Maintenance](/paul/process/01-game-maintenance/) — fossil fuel concentration is one of the clearest examples of the game-maintenance problem; the political power generated by the resource is one reason planning has been blocked.
- [Growing up with civil service](/paul/policy/06-mandatory-civil-service/) — the energy transition is a generation-scale undertaking; civil service infrastructure is one staffing pipeline for the work.
- [The American Experiment](/paul/process/02-american-experiment/) — long-time-horizon problems require institutional capacity to plan beyond electoral cycles. The transition is a test case.
