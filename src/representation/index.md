...
description: Three nested proposals on American representation — constituent organizing within current districts, a constitutional convention pathway, and a tripartite-at-three-levels redesign of federal government.
updated: 2026-04-26
---

# The Representation Problem

<p class="domain-lead">The U.S. Congress was designed for a country of roughly 4 million people. The Constitution mandated one House representative per 30,000 constituents (Article I, Section 2). Today each House member represents approximately 761,000 — a 25-fold dilution since the founding. If we'd kept the original ratio, the House would have roughly 11,000 members. This isn't a quirky historical observation; it's a structural crisis. The information load on a single legislator — understanding the needs, preferences, and conditions of three-quarters of a million people across dozens of policy domains — exceeds any reasonable model of democratic representation. This proposal is three nested ones: a strategy that can be pursued today inside the current system, a structural pathway that requires constitutional change, and a sketch of what a redesigned federal government might look like if we get the chance to redesign one.</p>
...
This proposal is also the structural design that the [PA-3 empower project](/paul/campaign/empower/) is one applied case of: domains as topical seats, organized by what laws affect rather than only by where they apply.
...
- *They'll gut the Bill of Rights*
- *Special interests will hijack it*
- *It'll be 1787 again — anything could happen*
- *The other side will get more than we do*
...
- **"The ratification requirement is the safeguard."** Nothing a convention proposes becomes law without 38 states agreeing. That's an extraordinarily high bar. A runaway convention cannot run away past that bar.
- **"We've already done this."** The founders themselves did this, under far more uncertain conditions, with far less institutional infrastructure.
- **"The alternative is worse."** If structural problems cannot be fixed through the structures that have the problems, the alternative to a convention isn't stability — it's decay.
- **"Transparency is the new safeguard."** Unlike 1787, a modern convention would operate under public scrutiny, live-streamed, with every draft proposal published in real time. The conditions that enabled the founders to operate in secrecy do not exist today.
...
- **Roman Republic:** Two consuls, serving simultaneously, each with veto power over the other. The system lasted roughly 500 years (509–27 BCE) (Lintott, *The Constitution of the Roman Republic,* 1999).
- **Swiss Federal Council:** Seven members, elected by parliament, serving as a collective executive since 1848. The presidency rotates annually and is largely ceremonial. Switzerland has one of the most stable governments in the world (Church & Head, 2013).
- **French Directoire (1795–1799):** A five-member executive. It failed — but for reasons specific to the post-revolutionary French context (military overreach by Napoleon, economic crisis), not because plural executives are inherently unworkable (Lyons, 1975).
- **The Spartan dyarchy:** Two kings from different royal houses, simultaneously. Persisted for centuries as a check on executive overreach.
...
- Hsiao, Y. T., Tang, A., et al. (2018). vTaiwan: An Empirical Study of Open Consultation Process. SocArXiv Preprint.
